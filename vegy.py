...
def extract_insert_apch(file_name):
    ...
    waypoint_types = [x for x in df.iloc[:, 2].tolist() if x]
            ...
            print("rgt")
                ...
                if data_parts[0].isdigit() or data_parts[0].endswith("Mag"):
                        if data_parts[0].isdigit():
                            data_parts.insert(3,data_parts[6])
                            data_parts.insert(4, data_parts[7])
                            data_parts.insert(5, data_parts[8])
                            data_parts.insert(6, data_parts[9])
                            data_parts.pop(-1)
                            data_parts.pop(-2)
                            data_parts.pop(-3)
                            data_parts.pop(-4)
