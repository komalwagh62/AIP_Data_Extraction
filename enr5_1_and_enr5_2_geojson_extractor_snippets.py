...
def fetch_data(json_data):
    ...
    for feature in json_data['features']:
        ...
        item_data = {
            'Identi_No': properties.get('Identi_No', None),
...
if __name__ == "__main__":
    geojson_file = r'C:\Users\LENOVO\Desktop\ANS_Register_Extraction\AIP_Data_Extraction\ENR5.1_5.2_Final.geojson'
